...
router.get("/getCandidateStarredDetails", candidate_controller.getCandidateStarredDetails.controller)
...
router.get("/getSelectedCandidates", candidate_controller.getSelectedCandidates.controller)


router.post("/updateCandidateCommand", candidate_controller.updateCandidateCommand.controller)
router.get("/myCandidate", candidate_controller.getUserCandidates .controller)
router.get("/downloadmyCandidate", candidate_controller.downloadMyCandidates.controller)
