...
export function EditUploadPopup(props) {
        ...
        axiosPrivateCall.post(`/api/v1/client/addClientDocuments`, formData)
            .then((res) => {
                ...
                setPipelineData((prevPipelineData) => ({
                    ...prevPipelineData,
                    documents: [...prevPipelineData.documents, ...fileuploaded],
                }));
                setBasicInfo((prev) => {
                    let buffer = { ...prev };
    ...
    const submitHandler = async () => {
        ...
        try {
            const response = await axiosPrivateCall.put(`/api/v1/crm/updateData/${basicInfo._id}`, basicInfo);
                ...
                <div className={styles.closePopup}>
                    ...
                    <div className={styles.bottomContainer}>
                        ...
                        <div className={styles.buttonContainer}>
                            <PrimaryButton onClick={() => submitHandler()}>Done</PrimaryButton>
                        </div>
                    </div>
