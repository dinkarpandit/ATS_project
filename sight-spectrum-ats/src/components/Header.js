...
function Header(props) {
  ...
  if (mainPath === "dashboard") {
    ...
    if (subPath === "addsubmission") {
      ...
      Breadcrumb = { mainpath: "Submission", subpath: "Submission Aprroval" };
    ...
    if (subPath === "leadsall") {
      Breadcrumb = { mainpath: "leads", subpath: " Leads Listing" };
    } if (subPath === "AddLeadModal") {
      Breadcrumb = { mainpath: "leads", subpath: "Add Leads" };
    } else if (subPath === "leadsactive") {
      Breadcrumb = { mainpath: "managelead", subpath: "Manage Leads" };
    } else if (subPath === "leadspassive") {
      Breadcrumb = { mainpath: "leadsbucket", subpath: "Leads Bucket" };
    } 
  } else if (mainPath === "candidatelibrary") {
    if (subPath === "mycandidate") {
      Breadcrumb = { mainpath: "Candidate Library", subpath: "My Candidate" };
