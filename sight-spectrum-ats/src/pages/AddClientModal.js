...
const AddCandidateModal = (props) => {
	...
	console.log(basicDetails.length,basicDetails)
						...
						<div className={styles.header_content_title_container}>
							...
							<div className={styles.header_content_save_container}>
								...
								<div className={styles.header_save_close_btns_container}>
									...
									<div className={styles.resumeConsole1}>
										<div className={styles.resume_conatiner1} >
										...
										<tbody>
											...
											(<tr key={index} className={styles.table_row}>
												...
												{/* <td className={styles.table_dataContents}>
													...
													<td className={styles.table_dataContents}>
													<div className={ (index===0)? styles.disableFirstIcon : ((basicDetails[index]?.id || basicDetailserrors[index]?.id) ? styles.showfield : styles.hidefield)}>
													 {(basicDetails.length>1 &&
														<Icon
															key={index}
															...
															if (basicDetails.length > 1) {
																handleRemoveItem(index, setBasicDetails, setBasicDetailserrors);
															}
															}}
														/>
														)}
									...
									<table>
										...
										<tbody>
											...
											(<tr key={index} className={styles.table_row}>
												...
												<td className={styles.table_dataContents}>
													<div className={(index===0)?styles.DisableFirstIcon :(clientDetails[index]?.id || clientDetailserrors[index]?.id) ? styles.showfield : styles.hidefield} >
													 {( clientDetails.length>1 && <Icon key={index} iconName='ChromeClose' className={tableCloseIconClass} onClick={() => { if (clientDetails.length > 1) handleRemoveItem(index, setClientDetails, setClientDetailserrors) }} />)}
													</div>
												</td>
											</tr>))}
										</tbody>
													...
													<div className={styles.table_heading}>
														...
														<div className={styles.resumeConsole}>
															<div className={styles.resume_conatiner} >
																<DefaultButton className={`${styles.resumeE1} ${basicInfoerrors.resume_url ? styles.errorBtn : styles.regularBtn}`}>
																	<div className={styles.resumebtn}>
																		{/* <div className={styles.statusIcn} >
														<FontIcon className={styles.Icn} iconName={(basicInfo.documents.length) ? 'Accept': `${btnIcon}`}  />
																		...
																		<div className={styles.statustxt1}>
															...
															<div className={styles.upload_warning_msg1}>
                                        * Kindly upload Excel files below 1 Mb
                                    						</div>
														</div>
													</div>
												</th>
