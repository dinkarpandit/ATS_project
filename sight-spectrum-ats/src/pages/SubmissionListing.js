...
const isRowChecked = (SubmissionId) => {
  ...
  const fetchMoreData = () => {
    ...
    if (isUserSearching) {
      ...
      axiosPrivateCall.get(`/api/v1/submission/listSubmissions?skip=${fetchOptions.skip + fetchOptions.limit}&limit=${fetchOptions.limit}&
